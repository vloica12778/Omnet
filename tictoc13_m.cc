...
//updated by styves
void TicTocMsg13::setType(std::string type){
    this->type = type;
}

std::string TicTocMsg13::getType() const
{
    return this->type;
}

void TicTocMsg13::setList( std::vector< int > list)
{
    this->list = list;
}

std::vector< int > TicTocMsg13::getList() const
{
    return this->list;
}
...
int TicTocMsg13::getM() const
{
    return this->m;
}

void TicTocMsg13::setM(int m)
{
    this->m = m;
}
